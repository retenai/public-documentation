...
1. **¿Cómo manejar cambios de territorio?**
   - Mantener histórico de asignaciones
   - Establecer períodos de transición
   - Gestionar transferencia de clientes

2. **¿Cómo gestionar jerarquías temporales?**
   - Usar asignaciones con fechas
   - Mantener supervisor principal y temporal
   - Documentar en atributos

3. **¿Cómo manejar vendedores multi-rol?**
   - Rol principal en campo `role`
   - Roles adicionales en `permissions`
   - Documentar en atributos 